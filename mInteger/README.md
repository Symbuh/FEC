...
- [ ] Refactor the `TransactionList` component (in the `client/src/components` directory) to dynamically render transactions using the dummy data in `dummy_data.js`. You may create additional components as necessary.
